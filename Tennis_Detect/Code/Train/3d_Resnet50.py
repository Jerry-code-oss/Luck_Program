...
train_dataset = TennisDataset(video_folder='D:\Tennis_Detect\Datasets\Group(3) Video\Totaldata\Opponent\Trial')
...
dataloaders = {
    ...
    'val': DataLoader(val_dataset, batch_size=8, shuffle=True, num_workers=0)
}
