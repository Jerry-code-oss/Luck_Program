...
model.load_state_dict(torch.load('D:/Tennis_Detect/Model/3dResnet50/Opponent_Best_Model.pth'))  # 替换为你的模型路径
model = model.to('cuda')
model.eval()
...
output_video_path = 'D:/Tennis_Detect/opponent_demo.mp4'
